...
// ====================== RAZER BASILISK V3 SPOOF ======================
#define USB_VID  0x1532     // Razer VID
#define USB_PID  0x00A0     // Basilisk V3 PID (common)

static const uint8_t PROGMEM manufacturer[] = "Razer";
static const uint8_t PROGMEM product[]      = "Razer Basilisk V3";
static const uint8_t PROGMEM serial[]       = "RAZ123456789";   // You can change this

// Apply spoof before USB starts
void setup() {
  usb_set_vidpid(USB_VID, USB_PID);
  usb_set_manufacturer_string((const uint8_t*)manufacturer);
  usb_set_product_string((const uint8_t*)product);
  usb_set_serial_string((const uint8_t*)serial);
  ...
  Serial.println("Teensy 4.1 Razer Basilisk V3 Bridge Ready");
  Serial.println("Plug physical mouse into Teensy USB Host port.");
}
// =====================================================================
...
void handleSerialCommand(char *line) {
  int dx = 0, dy = 0, wheel = 0, wheelH = 0, buttons = 0;
